...
void Controller::checkForUpdate(bool silent) {
    ...
    QUrl cmcURL("https://api.github.com/repos/ZcashFoundation/arkwallet/releases");
            ...
            if (reply->error() == QNetworkReply::NoError) {
                ...
                if (maxVersion > currentVersion && (!silent || maxVersion > maxHiddenVersion)) {
                    ...
                    if (ans == QMessageBox::Yes) {
                        QDesktopServices::openUrl(QUrl("https://github.com/ZcashFoundation/arkwallet/releases"));
                    } else {
